...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    private void seedAnimais() {
        if (animalRepository.count() == 0) {
            ...
            UsuarioSaveWithIdDTO usuario = new UsuarioSaveWithIdDTO(1, "Admin", "999.999.999-99", dataNascimento, "(99) 99999-9999", UserTipo.FUNCIONARIO, "admin@email.com", "Admin@123");
            Usuario usuarioSeed = new Usuario(usuario);

            Animal animalSeed = new Animal(1, "Animal", dataNascimento, "especie", "raca", AnimalTipo.MASCULINO, "porte", "pelagem", "cor", 5.5, usuarioSeed);
