...
public interface AnimalRepository extends JpaRepository<Animal,Long> {   
    ...
    @Query("SELECT new com.project.pet.dto.Animal.AnimalDTO(a.id, a.nome, a.data_nascimento, a.especie, a.raca, a.tipo, a.porte, a.cor, a.peso, u.id, u.cpf) FROM Animal a JOIN a.usuario u WHERE a.id = :id")
